...
const coverImageUpdate=asyncHandler(async(req,res)=>{
    ...
    if (!coverImageLocalPath) {
        throw new ApiError(400,"acoverImage file is required")
    }
    const coverImage=await uploadOnCloudinary(coverImageLocalPath)
    if(!coverImage){
        throw new ApiError(400,"Error in uploading on coverImage")
    }
...
export {registerUser, loginUser, logoutUser,
    ...
    updateAccountDetails,avatarUpdate,coverImageUpdate,
    getUserChannelProfile,getVideoHistory
}